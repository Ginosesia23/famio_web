...
/** Renders the "Famio" wordmark with a purple heart in place of the i-dot. */
function FamioName() {
  return (
    <>
      <span aria-hidden="true">Fam</span>
      <span className="famio-i" aria-hidden="true">
        <svg
          className="famio-i-heart"
          viewBox="0 0 24 24"
          aria-hidden="true"
          focusable="false"
        >
          <path
            fill="currentColor"
            d="M12 21.6c-.55 0-1.09-.21-1.5-.6-2.2-2.06-4.06-3.85-5.36-5.5C3.78 13.78 3 12.05 3 10.27 3 7.36 5.27 5 8.1 5c1.54 0 3 .72 3.9 1.86C12.9 5.72 14.36 5 15.9 5 18.73 5 21 7.36 21 10.27c0 1.78-.78 3.51-2.14 5.23-1.3 1.65-3.16 3.44-5.36 5.5-.41.39-.95.6-1.5.6z"
          />
        </svg>
        {'\u0131'}
      </span>
...
const FAMIO_BETA_EMAIL = 'hello@famio.app'
...
function BetaSignupSection() {
  ...
  const handleSubmit = (ev: FormEvent<HTMLFormElement>) => {
    ...
    if (!em) {
      setFormError('Add your email so we can send beta details.')
      return
    }
    if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(em)) {
    ...
    if (!devices) {
      setFormError('Pick the device you use most—we’ll match you to the right build.')
      return
    }

    const body =
      'Hi Famio team — I’d like to join the Famio beta.\n\n' +
      `Name (optional): ${contactName.trim() || '—'}\n` +
      `Email: ${em}\n` +
    ...
    window.location.href =
      `mailto:${FAMIO_BETA_EMAIL}?subject=` +
      encodeURIComponent('Famio beta signup') +
      '&body=' +
  ...
  return (
    <section
      ...
      id="beta"
      aria-labelledby="beta-program-heading"
    >
      <div className="beta-program-glow" aria-hidden={true} />
      <div className="section-inner beta-program-inner">
        <div className="beta-program-grid">
          <div className="beta-program-copy">
            <span className="beta-program-dots brand-dots" aria-hidden={true}>
              <span className="brand-dot brand-dot--mint" />
              <span className="brand-dot brand-dot--sky" />
              <span className="brand-dot brand-dot--accent" />
            </span>
            <p className="beta-program-kicker">Beta program</p>
            <h2 id="beta-program-heading" className="beta-program-title">
              Be one of the first to test Famio
            </h2>
            <p className="beta-program-lede">
              We&apos;re inviting real families to try new builds early—chat, the
              live map, travel updates, and the rough edges we&apos;re still
              polishing. Your feedback shapes what ships next.
            </p>
            <ul className="beta-program-points">
              <li>Early access to new features before public release</li>
              <li>Direct line to the team (we read every note)</li>
              <li>No spam—just occasional invites and short surveys</li>
            </ul>
          </div>

          <div className="beta-program-card">
            <p className="beta-program-form-title">Request a spot</p>
            <p className="beta-program-form-sub">
              Submitting opens your email with a pre-filled message you can edit
              before sending.
            </p>
            <form className="beta-form" onSubmit={handleSubmit} noValidate>
              <div className="beta-form-field">
                <label htmlFor="beta-name">Your name (optional)</label>
                <input
                  id="beta-name"
                  name="name"
                  type="text"
              ...
              <div className="beta-form-field">
                <label htmlFor="beta-device">Primary device</label>
                <select
                  id="beta-device"
                  name="device"
                  value={devices}
                ...
                >
                  ...
                  <option value="Both iPhone and Android in our home">
                    Both iPhone and Android in our home
                  </option>
                  <option value="Not sure yet">Not sure yet</option>
                </select>
              </div>
              <div className="beta-form-field">
                <label htmlFor="beta-notes">
                ...
                <textarea
                  ...
                  placeholder="Family size, what you’d love to stress-test…"
                />
              </div>
              {formError ? (
              ...
              <button className="btn btn-primary beta-form-submit" type="submit">
                Send beta request
              </button>
              <p className="beta-form-hint">
                Goes to{' '}
                <span className="beta-form-email">{FAMIO_BETA_EMAIL}</span>
              </p>
            </form>
          </div>
        </div>
...
function FamioLanding() {
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      } else if (y > prev + directionThreshold) {
  ...
  const headerOffScreen = headerScrollHidden && !navOpen
  ...
  return (
    <div className="page">
      ...
      <header
        className={`header ${navOpen ? 'header--nav-open' : ''} ${
          headerOffScreen ? 'header--scroll-hidden' : ''
        }`}
      >
        <div className="header-inner">
          <Link className="brand" to="/" onClick={closeNav}>
            <span className="brand-wordmark" aria-label="Famio">
              <FamioName />
            </span>
          ...
          <div className="header-end">
            <a className="btn btn-primary header-cta" href="#beta">
              Join beta
            </a>
            <button
              type="button"
      ...
      <main>
        <section className="hero" aria-labelledby="hero-heading">
          <div className="hero-copy">
            <p className="eyebrow">The family coordination app</p>
            <h1 id="hero-heading">
              Family chat, a live map, and trip updates—in one place
            </h1>
            <p className="hero-lead">
              Famio is built for busy households: one feed for group messages,
              a shared map so you know where everyone is, and smart context
              from flights, calendars, and invites—without retyping the plan or
              chasing updates across a pile of apps.
            </p>
            <p className="lede">
              Travel mode covers road trips and longer journeys; flight changes
              and ETAs show up in chat; and notifications stay helpful instead
              of noisy—so you spend less time asking &ldquo;where are
              you?&rdquo; and more time being together.
            </p>
            <ul className="hero-tags" aria-label="What you get with Famio">
              <li>Family chat &amp; feed</li>
              <li>Live map</li>
              <li>Flights &amp; calendar</li>
              <li>Travel mode</li>
            </ul>
            ...
            <p className="hero-tertiary">
              <a href="#chat-events">Peek at features</a>
            </p>
          </div>
                    ...
                    <div className="hero-phone-feed">
                      <div className="hero-msg hero-msg--mom">
                        ...
                        <div className="hero-msg-bubble">
                          Grandma left late but Famio says she&apos;s landing
                          early now—new ETA in the card ✈️
                        </div>
                      </div>

                      <div className="hero-flight-card hero-flight-card--recovery">
                        ...
                        <p className="hero-flight-depart">
                          Departed 22 min late
                        </p>
                        <p className="hero-flight-was">Sched. arrival 3:14 PM</p>
                        ...
                        <div className="hero-flight-meta">
                          <span>Est. 3:06 PM</span>
                          <span className="hero-flight-dot" />
                          <span>8 min early</span>
                          <span className="hero-flight-dot" />
                          <span>Gate B12</span>
                        </div>
                      </div>
                      ...
                      <div className="hero-msg hero-msg--you">
                        ...
                        <div className="hero-msg-bubble hero-msg-bubble--you">
                          Same—saw she&apos;s ahead of schedule in Famio. On our
                          way to pick her up!
                        </div>
                      </div>
              ...
              >
                ...
                <h3 id="tier-famio-name" className="tier-name tier-name--with-brand">
                  <span className="tier-name-lockup">
                    <span className="tier-name-wordmark" aria-label="Famio">
                      <FamioName />
                    </span>
              ...
              <div className="download-card-grid">
                <div className="download-card-main">
                  <div className="download-brand-lockup" aria-hidden={true}>
                    <span className="download-brand-word" aria-label="Famio">
                      <FamioName />
                    </span>
        ...
        <div className="footer-inner">
          <div className="footer-row">
            <div className="footer-brand-block">
              <p className="footer-brand" aria-label="Famio">
                <FamioName />
              </p>
